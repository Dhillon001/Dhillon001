...
### Languages 
Python • C++ • Java • SQL • JavaScript • TypeScript • R • Scheme 

### Software & Infrastructure 
Linux/Unix • Bash • Git • REST APIs • Next.js • Vercel 

### Data & Machine Learning 
Pandas • NumPy • Scikit-Learn • Streamlit • Statistical Modeling • Data Visualization 

### AI & LLMs 
OpenAI API • Hugging Face • Prompt Engineering • AI Evaluation 

### Data Engineering 
Apache Airflow • Apache Spark • ETL Pipelines • Automation & Pipeline Development 
...
|--------|-------------|------|
| **AI Meeting Assistant** | Full-stack AI application that analyzes meeting transcripts, generates structured summaries, extracts action items, and automates project organization workflows | Next.js, TypeScript, OpenAI API, Vercel | 
